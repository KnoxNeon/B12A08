...
const Hero = () => {
  return (
    <div className="flex flex-col justify-center text-center   w-full mx-auto bg-[#f3f3f3] ">
      <h1 className='text-[#001931] text-3xl md:text-7xl font-bold text-shadow-2xl mt-10 md:mt-14'>We Build <br /> <span className='bg-linear-to-r from-[#632EE3] to-[#9F62F2] bg-clip-text text-transparent'>Productive</span> Apps</h1>
