  ...
  return (
    <div className=''>
      ...
      <div className='flex justify-between mt-2 mx-20'>
        <h1 className=' text-2xl font-bold'><span>{installed.length}</span> Apps Found</h1>
        ...
        <div className='flex items-center gap-6'>
          ...
          <div className="">
            ...
            <div className="flex gap-6">
              <p className="flex items-center gap-0.5 text-[#00D390] text-base font-medium "> <IoMdDownload />{a.downloads}</p>
              <p className="flex items-center gap-0.5 text-[#FF8811] text-base font-medium "><FaStar />{a.ratingAvg}</p>
              <p className="flex items-center gap-0.5 text-[#627382] text-base font-medium">{a.size} MB</p>
            </div>
          </div>
        </div>
