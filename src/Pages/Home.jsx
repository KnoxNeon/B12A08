...
const Home = () => {
  ...
  return (
    ...
    <div>
      ...
      <div className="flex justify-center"><Link className='btn btn-ghost  text-white bg-linear-to-r from-[#632EE3] to-[#9F62F2] px-8 mb-10' to='/apps'>See All</Link></div></div>
